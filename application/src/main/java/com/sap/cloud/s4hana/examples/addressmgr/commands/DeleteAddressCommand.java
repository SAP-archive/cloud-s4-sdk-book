...
public class DeleteAddressCommand extends ErpCommand<Integer> {
    ...
    public DeleteAddressCommand(final String businessPartnerId, final String addressId) {
    ...
    protected Integer run() throws Exception {
        ...
        final ODataDeleteResult oDataDeleteResult = new DefaultBusinessPartnerService()
